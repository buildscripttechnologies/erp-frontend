...
const Dash = () => {
  ...
  return (
    <Dashboard>
      {/* Users & Orders */}
      <h2 className="text-3xl font-semibold ml-[1%] border-b-4 w-20 border-[#d8b76a] ">
        Users
      </h2>
      <div className="relative mt-4 gap-8 w-[98%] mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3">
        <DashboardCard title="Admin" value="5" />
        <DashboardCard title="Editor" value="3" />
        <DashboardCard title="Viewer" value="8" />
      </div>
      <h2 className="text-3xl font-semibold mt-8 ml-[1%] border-b-4 w-25 border-[#d8b76a] ">
        Orders
      </h2>
      <div className="relative w-[98%] mx-auto flex flex-col md:flex-row gap-5 items-center justify-between">
        <div className="mt-4 gap-6 w-full md:w-1/2 grid grid-cols-1 sm:grid-cols-2 ">
      ...
      {/* Tables */}
      <h2 className="text-3xl font-semibold mt-8 ml-[1%] border-b-4 w-22 border-[#d8b76a]">
        Tables
      </h2>
      <div className="mt-4 w-[98%] mx-auto grid grid-cols-1 lg:grid-cols-2 gap-4">
        <OrderTable
