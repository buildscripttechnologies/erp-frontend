  ...
  return (
    <div className="bg-white border border-primary rounded shadow pt-3 pb-4 px-4 mx-2 mb-2 text-[11px] text-black">
      ...
      <table className="w-full mb-2 text-[11px] border text-left">
        ...
        <tbody>
          {quotationData.productDetails?.length > 0 ? (
            quotationData.productDetails.map((item, idx) => (
      ...
      <table className="w-full mb-4 text-[11px] border text-left">
        ...
        <tbody>
          {quotationData.consumptionTable?.length > 0 ? (
            quotationData.consumptionTable.map((item, idx) => (
              <tr key={idx} className="border-b border-primary">
                <td className="px-2 py-1 border-r border-primary">{idx + 1}</td>
                <td className="px-2 py-1 border-r border-primary ">
                  {item.skuCode || "N/A"}
      ...
      <table className="w-full  text-[11px] border border-primary  rounded">
        <tbody>
          <tr className="border-b border-primary">
            ...
            <td className="px-2 py-1 border-r border-primary">
              {quotationData.stitching || "0"}
            </td>
            <td className="font-semibold bg-[#f8f8f8] px-2 py-1 border-r border-primary">
              Print/Emb (₹)
            </td>
            <td className="px-2 py-1 border-r border-primary">
              {quotationData.printing || "0"}
            </td>
            <td className="font-semibold bg-[#f8f8f8] px-2 py-1 border-r border-primary">
              Others (₹)
            </td>
            <td className="px-2 py-1 border-r border-primary">
              {quotationData.others || "0"}
            </td>
          </tr>
          <tr className="border-b border-primary">
            <td className="font-semibold bg-[#f8f8f8] px-2 py-1 border-r border-primary">
            ...
            <td className="px-2 py-1 border-r border-primary">
              {quotationData.unitRate || "0"}
            </td>
            <td className="font-semibold bg-[#f8f8f8] px-2 py-1 border-r border-primary">
              Unit B2B (₹)
            </td>
            <td className="px-2 py-1 border-r border-primary">
              {quotationData.unitB2BRate || "0"}
            </td>
            <td className="font-semibold bg-[#f8f8f8] px-2 py-1 border-r border-primary">
              Unit D2C (₹)
            </td>
            <td className="px-2 py-1 border-r border-primary">
              {quotationData.unitD2CRate || "0"}
            </td>
          </tr>
          <tr className="border-b border-primary">
            <td className="font-semibold bg-[#f8f8f8] px-2 py-1 border-r border-primary">
            ...
            <td className="px-2 py-1 border-r border-primary">
              {quotationData.totalRate || "0"}
            </td>
            <td className="font-semibold bg-[#f8f8f8] px-2 py-1 border-r border-primary">
              Total B2B (₹)
            </td>
            <td className="px-2 py-1 border-r border-primary">
              {quotationData.totalB2BRate || "0"}
            </td>
            <td className="font-semibold bg-[#f8f8f8] px-2 py-1 border-r border-primary">
              Total D2C (₹)
            </td>
            <td className="px-2 py-1 border-r border-primary">
              {quotationData.totalD2CRate || "0"}
            </td>
          </tr>
        </tbody>
      </table>
